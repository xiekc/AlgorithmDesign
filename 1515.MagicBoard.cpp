...
//		}
        ...
        for(int i=0;i<2;i++)
        	for(int j=0;j<2;j++)
            	swap(temp.board[i][j],temp.board[i][j+2]);
        ...
        temp.board[0][1]=temp.board[0][2];
        temp.board[0][2]=temp.board[1][2];
        temp.board[1][2]=temp.board[1][1];
        temp.board[1][1]=t;
